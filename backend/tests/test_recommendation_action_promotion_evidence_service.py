...
def _draft(*, minimum_incremental: float = 0.01, maximum_regret: float = 0.10) -> dict:
    states = {
        state: {
    ...
    return {
        "artifactVersion": "athena-action-promotion-protocol-v1",
...
def _confirmation(*, incremental: float = 0.02, regret: float = 0.05) -> dict:
    states = {}
