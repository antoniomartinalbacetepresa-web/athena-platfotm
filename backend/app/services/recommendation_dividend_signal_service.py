...
class RecommendationDividendSignalService:
    ...
    def evaluate(self, *, symbol: str, as_of: datetime) -> RecommendationDividendSignal:
        ...
        instrument_id = self._optional_int(market.get("instrumentId")); latest_price = self._optional_float(market.get("latestPrice")); providers = market.get("sourceProviders")
