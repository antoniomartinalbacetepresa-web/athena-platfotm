...
SOURCES: tuple[AthenaSource, ...] = (
    ...
    AthenaSource("sec_edgar_xbrl", "SEC EDGAR / XBRL", "fundamentals", ("10-k", "10-q", "8-k", "20-f", "financial_statements", "filing_notes"), "ready_to_integrate", True, True, False, "Primary official source for US issuer fundamentals and filings."),
    AthenaSource("sec_13f", "SEC Form 13F", "investors", ("institutional_holdings", "new_positions", "increases", "reductions", "closed_positions"), "ready_to_integrate", True, True, False, "13F filings are delayed and must never be treated as real-time trades."),
    AthenaSource("sec_form4", "SEC Form 4", "insiders", ("insider_buys", "insider_sells", "ownership_changes"), "ready_to_integrate", True, True, False, "Transactions require classification before they become an ATHENA signal."),
    AthenaSource("fred_alfred", "FRED / ALFRED", "macro", ("macro_series", "rates", "inflation", "employment", "historical_vintages"), "credentials_required", True, True, True, "Free FRED API key. ALFRED vintages reduce look-ahead and revision bias."),
    AthenaSource("ecb", "European Central Bank Data Portal", "macro", ("rates", "money", "credit", "fx", "euro_area_macro"), "ready_to_integrate", True, True, False, "Primary official euro-area monetary and financial source."),
    ...
    AthenaSource("cftc_cot", "CFTC Commitments of Traders", "positioning", ("futures_positioning", "commodities", "indices", "rates", "fx"), "ready_to_integrate", True, True, False, "Provides positioning context for macro and commodity-sensitive assets."),
    ...
    AthenaSource("world_bank", "World Bank Indicators", "macro", ("country_risk", "growth", "demographics", "trade", "development"), "ready_to_integrate", True, True, False, "Ingest a curated subset of useful series."),
    ...
    AthenaSource("google_trends", "Google Trends", "alternative_data", ("search_interest", "brand_interest", "emerging_topics"), "restricted_access", True, True, False, "Official API access is limited; ATHENA must not depend on unavailable alpha access."),
    AthenaSource("google_news", "Google News / original publishers", "news", ("news_discovery", "company_events", "sector_events", "macro_events"), "research_required", False, True, False, "Retain the original publisher, deduplicate syndication, and respect licensing/terms."),
